...
Obtém a lista de empresas afiliadas a uma empresa.
...
**Note:** Certifique-se de ajustar a formatação e os títulos conforme necessário para a exibição no seu README no GitHub.
